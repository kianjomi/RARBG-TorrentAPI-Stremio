...
$tapiurl = 'https://torrentapi.org/pubapi_v2.1.php?app_id='.$appid.'&mode=search&search_string='.$seaepi.'&search_imdb='.$imdbtv.'&category=18;41&sort=seeders&limit=10&format=json_extended&token='.$token.'';
} else {
$tapiurl = 'https://torrentapi.org/pubapi_v2.1.php?app_id='.$appid.'&mode=search&search_imdb='.$imdb.'&category=17;44;45&sort=seeders&limit=10&format=json_extended&token='.$token.'';
}
